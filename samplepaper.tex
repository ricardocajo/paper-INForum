...
%
\author{Ricardo Cordeiro\inst{1}\orcidID{0000-1111-2222-3333} \and
Alcides Fonseca\inst{1}\orcidID{1111-2222-3333-4444} \and
Christopher Timperley\inst{2}\orcidID{2222--3333-4444-5555}}
%
\authorrunning{F. Author et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{Faculdade de Ciˆencias da Universidade de Lisboa,
Lisboa, Portugal \and
